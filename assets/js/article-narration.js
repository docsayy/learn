/*
 * Learn Medicine — Floating Article Narration v4.2.0
 * Browser-native narration using the Web Speech API.
 *
 * Add before </body>:
 * <script src="../assets/js/article-narration.js?v=4.2.0"></script>
 *
 * The script automatically loads ../css/article-narration.css?v=4.2.0.
 */
